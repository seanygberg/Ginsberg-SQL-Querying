...
SELECT name FROM products_db.products;
--Display all of the names and prices of the products.
SELECT name, price FROM products_db.products;
--Add a new product - make up whatever you would like!
INSERT INTO products (name, price, can_be_returned) VALUES ('hat', 69.00, 1);
--Display only the products that can_be_returned
SELECT * FROM products_db.products WHERE can_be_returned = 1;
--Display only the products that have a price less than 44.00.
SELECT * FROM products_db.products WHERE price < 44;
--Display only the products that have a price in between 22.50 and 99.99.
SELECT * FROM products_db.products WHERE price BETWEEN 22.5 AND 99.99;
